...
public class RibbonBarPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[5]/div/a")
    private WebElement ribbonBarHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[5]/div/a")
    private WebElement ribbonBar;
    ...
    private WebElement uniqueNavigation;
    ...
    private WebElement quickAccessToolbar;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[5]/a")
    private WebElement contextualTabs;
    ...
    public RibbonBarPage(WebDriver driver){
    ...
    public void hoverOverRibbonBarBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(ribbonBarHover).build().perform();
    }

    public void ribbonBarClick(){click(ribbonBar);}
    ...
    public void uniqueNavigationClick(){click(uniqueNavigation);}

    public void templatesClick(){click(templates);}

    public void keyboardSupportClick(){click(keyboardSupport);}

    public void quickAccessToolbarClick(){click(quickAccessToolbar);}

    public void contextualTabsClick(){click(contextualTabs);}
