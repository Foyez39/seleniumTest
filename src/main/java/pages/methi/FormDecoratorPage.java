...
public class FormDecoratorPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[5]/div/div[1]/div/a")
    private WebElement formDecoratorHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[5]/div/div[1]/div/a")
    private WebElement formDecorator;
    ...
    private WebElement regularControls;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement validationLoginControls;
    ...
    public FormDecoratorPage(WebDriver driver){
    ...
    public void hoverOverFormDecoratorBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(formDecoratorHover).build().perform();
    }

    public void formDecoratorClick(){click(formDecorator);}
    ...
    public void regularControlsClick(){click(regularControls);}

    public void validationLoginControlsClick(){click(validationLoginControls);}
