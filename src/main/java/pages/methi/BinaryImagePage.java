...
public class BinaryImagePage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[8]/div/div[2]/div/a")
    private WebElement binaryImageHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[8]/div/div[2]/div/a")
    private WebElement binaryImage;
    ...
    private WebElement integrateIntoDataBoundControls;
    ...
    public BinaryImagePage(WebDriver driver){
    ...
    public void hoverOverBinaryImageBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(binaryImageHover).build().perform();
    }

    public void binaryImageClick(){click(binaryImage);}
    ...
    public void displayImagesClick(){click(displayImages);}

    public void integrateIntoDataBoundControlsClick(){click(integrateIntoDataBoundControls);}
