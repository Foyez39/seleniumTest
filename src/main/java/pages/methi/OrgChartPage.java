...
public class OrgChartPage extends CommonAPI {
    ...
    private WebElement orgChartHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[8]/div/div[7]/div/a")
    private WebElement orgChart;
    ...
    private WebElement organizationLayout;
    ...
    private WebElement expandCollapseItem;
    ...
    public void hoverOverOrgChartBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(orgChartHover).build().perform();
    }

    public void orgChartClick(){click(orgChart);}
    ...
    public void organizationLayoutClick(){click(organizationLayout);}
    ...
    public void expandCollapseItemSupportClick(){click(expandCollapseItem);}
