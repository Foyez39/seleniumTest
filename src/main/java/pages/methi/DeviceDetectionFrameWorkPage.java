...
public class DeviceDetectionFrameWorkPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[3]/div/div[2]/div/a")
    private WebElement deviceDetectionFrameworkHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[3]/div/div[2]/div/a")
    private WebElement deviceDetectionFramework;
    ...
    private WebElement detectScreenSize;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement integrationWithTelerik;
    ...
    public DeviceDetectionFrameWorkPage(WebDriver driver){
    ...
    public void hoverOverDeviceDetectionFrameworkBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(deviceDetectionFramework).build().perform();
    }

    public void deviceDetectionFrameworkClick(){click(deviceDetectionFramework);}
    ...
    public void detectScreenSizeClick(){click(detectScreenSize);}

    public void integrationWithTelerikClick(){click(integrationWithTelerik);}
