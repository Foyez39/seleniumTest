...
public class BreadCrumbPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[1]/div/a")
    private WebElement breadcrumbHover;
    ...
    private WebElement navigationSupport;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement RTLSupport;
    ...
    public void hoverOverBreadcrumbBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(breadcrumbHover).build().perform();
    }

    public void breadcrumbClick(){click(breadcrumb);}
    ...
    public void navigationSupportClick(){click(navigationSupport);}

    public void RTLSupportClick(){click(RTLSupport);}

    public void builtInSkinsClick(){click(builtInSkins);}

    public void overviewClick(){click(overview);}

    public void builtInIconsClick(){click(builtInIcons);}

    public void editingClick(){click(editing);}

    public void flexibleClientSideAPIClick(){click(flexibleClientSideAPI);}

    public void accessibilityKeyboardNavigationClick(){click(accessibilityKeyboardNavigation);}
