...
public class FileExplorerPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[9]/div/div[2]/div/a")
    private WebElement fileExplorerHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[9]/div/div[2]/div/a")
    private WebElement fileExplorer;
    ...
    private WebElement explorerInterface;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement uploadPreviewFiles;
    ...
    public FileExplorerPage(WebDriver driver){
    ...
    public void hoverOverFileExplorerBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(fileExplorerHover).build().perform();
    }

    public void fileExplorerClick(){click(fileExplorer);}
    ...
    public void explorerInterfaceClick(){click(explorerInterface);}

    public void uploadPreviewFilesClick(){click(uploadPreviewFiles);}

    public void fileDownloadClick(){click(fileDownload);}
