...
public class RatingPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[14]/div/div[2]/div/a")
    private WebElement ratingHover;
    ...
    private WebElement ratingMechanism;
    ...
    public void hoverOverRatingBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(ratingHover).build().perform();
    }

    public void ratingClick(){click(rating);}
    ...
    public void ratingMechanismClick(){click(ratingMechanism);}
