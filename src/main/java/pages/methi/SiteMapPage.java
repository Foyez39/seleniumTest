...
public class SiteMapPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[7]/div/a")
    private WebElement sitemapHover;
    ...
    private WebElement nodeLines;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement siteMapDataSource;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[4]/a")
    private WebElement semanticRendering;
    ...
    public void hoverOverSitemapBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(sitemapHover).build().perform();
    }

    public void sitemapClick(){click(sitemap);}
    ...
    public void nodeLinesClick(){click(nodeLines);}

    public void siteMapDataSourceClick(){click(siteMapDataSource);}

    public void semanticRenderingClick(){click(semanticRendering);}
