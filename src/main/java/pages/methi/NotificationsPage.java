...
public class NotificationsPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[3]/div/div[5]/div/a")
    private WebElement notificationsHover;
    ...
    public void hoverOverNotificationsBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(notificationsHover).build().perform();
    }

    public void notificationsClick(){click(notifications);}
    ...
    public void simpleNotificationsClick(){click(simpleNotifications);}

    public void settingContentClick(){click(settingContent);}

    public void bindToWebServicesClick(){click(bindToWebServices);}

    public void clientSideAPIClick(){click(clientSideAPI);}

    public void updateIntervalsClick(){click(updateIntervals);}
