...
public class ColorPickerPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[7]/div/div[2]/div/a")
    private WebElement colorPickerHover;
    ...
    public void hoverOverColorPickerBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(colorPickerHover).build().perform();
    }

    public void colorPickerClick(){click(colorPicker);}
    ...
    public void colorSelectionClick(){click(colorSelection);}
