...
public class ButtonPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[2]/div/a")
    ...
    private WebElement embeddedIcons;
    ...
    public void hoverOverButtonBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(buttonHover).build().perform();
    }

    public void buttonClick(){click(button);}
    ...
    public void expandedButtonBehaviorClick(){click(expandedButtonBehavior);}

    public void imageButtonsClick(){click(imageButtons);}

    public void toggleButtonsClick(){click(toggleButtons);}

    public void contentButtonsClick(){click(contentButtons);}

    public void accessibilityClick(){click(accessibility);}

    public void clientSideAPIClick(){click(clientSideAPI);}

    public void embeddedIconsClick(){click(embeddedIcons);}
