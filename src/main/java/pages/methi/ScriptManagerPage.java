...
public class ScriptManagerPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[12]/div/div[2]/div/a")
    private WebElement scriptManagerHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[12]/div/div[2]/div/a")
    private WebElement scriptManager;
    ...
    public void hoverOverScriptManagerBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(scriptManagerHover).build().perform();
    }

    public void scriptManagerClick(){click(scriptManager);}
