...
public class DragDropManagerPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[2]/div/a")
    private WebElement dragDropManagerHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[2]/div/a")
    private WebElement dragDropManager;
    ...
    private WebElement dragDropBuildingBlocks;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement customDragDrop;
    ...
    public DragDropManagerPage(WebDriver driver){
    ...
    public void hoverOverDragDropManagerBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(dragDropManager).build().perform();
    }

    public void dragDropManagerClick(){click(dragDropManager);}
    ...
    public void dragDropBuildingBlocksClick(){click(dragDropBuildingBlocks);}

    public void customDragDropClick(){click(customDragDrop);}
