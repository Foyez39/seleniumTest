...
public class BarcodePage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[8]/div/div[1]/div/a")
    private WebElement barcodeHover;
    ...
    private WebElement barcodeGeneration;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement barcodeTypes;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement qrCodeGeneration;
    ...
    public void hoverOverBarcodeBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(barcodeHover).build().perform();
    }

    public void barcodeClick(){click(barcode);}
    ...
    public void barcodeGenerationClick(){click(barcodeGeneration);}

    public void barcodeTypesClick(){click(barcodeTypes);}

    public void qrCodeGenerationClick(){click(qrCodeGeneration);}

    public void integrationClick(){click(integration);}
