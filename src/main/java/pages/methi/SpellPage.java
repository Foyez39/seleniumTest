...
public class SpellPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[2]/ul/li[10]/a")
    private WebElement SpellChecking;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[10]/div/div/div/a")
    private WebElement spellHover;
    ...
    private WebElement multipleLanguages;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement customDictionaries;
    ...
    public SpellPage(WebDriver driver){
    ...
    public void SpellCheckingClick(){click(SpellChecking);}

    public void hoverOverSpellBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(spellHover).build().perform();
    }

    public void spellClick(){click(spell);}
    ...
    public void multipleLanguagesClick(){click(multipleLanguages);}

    public void customDictionariesClick(){click(customDictionaries);}
