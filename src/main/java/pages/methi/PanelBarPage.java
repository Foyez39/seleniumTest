...
public class PanelBarPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[4]/div/a")
    private WebElement panelBarHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[4]/div/a")
    private WebElement panelBar;
    ...
    private WebElement easyNavigation;
    ...
    public PanelBarPage(WebDriver driver){
    ...
    public void hoverOverPanelBarBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(panelBarHover).build().perform();
    }

    public void panelBarClick(){click(panelBar);}
    ...
    public void easyNavigationClick(){click(easyNavigation);}

    public void dataBindingClick(){click(dataBinding);}

    public void hierarchyClick(){click(hierarchy);}
