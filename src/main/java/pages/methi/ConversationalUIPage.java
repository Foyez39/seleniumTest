...
public class ConversationalUIPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[1]/div/a")
    private WebElement conversationalUIHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[1]/div/a")
    private WebElement conversationalUI;
    ...
    public ConversationalUIPage(WebDriver driver){
    ...
    public void hoverOverConversationalUIBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(conversationalUI).build().perform();
    }

    public void conversationalUIClick(){click(conversationalUI);}
    ...
    public void radChatClick(){click(radChat);}
