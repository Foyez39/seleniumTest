...
public class SkinManagerPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[2]/ul/li[5]/a")
    private WebElement theming;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[5]/div/div[2]/div/a")
    private WebElement skinManagerHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[5]/div/div[2]/div/a")
    private WebElement skinManager;
    ...
    private WebElement themeSelection;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement intuitiveConfiguration;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement persistence;
    ...
    public SkinManagerPage(WebDriver driver){
    ...
    public void themingClick(){click(theming);}

    public void hoverOverSkinManagerHoverBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(skinManagerHover).build().perform();
    }

    public void skinManagerClick(){click(skinManager);}
    ...
    public void themeSelectionClick(){click(themeSelection);}

    public void intuitiveConfigurationClick(){click(intuitiveConfiguration);}

    public void persistenceClick(){click(persistence);}
