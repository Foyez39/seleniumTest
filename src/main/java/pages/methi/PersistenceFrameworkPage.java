...
public class PersistenceFrameworkPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[3]/div/a")
    private WebElement persistenceFrameworkHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[3]/div/a")
    private WebElement persistenceFramework;
    ...
    public PersistenceFrameworkPage(WebDriver driver){
    ...
    public void hoverOverPersistenceFrameworkBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(persistenceFramework).build().perform();
    }

    public void persistenceFrameworkClick(){click(persistenceFramework);}
    ...
    public void saveSettingsAnywhereClick(){click(saveSettingsAnywhere);}

    public void getFullControlClick(){click(getFullControl);}

    public void persistCustomKeyValueSettingsClick(){click(persistCustomKeyValueSettings);}

    public void visualStudioIntegrationClick(){click(visualStudioIntegration);}

    public void highPerformanceClick(){click(highPerformance);}

    public void saveLoadSettingsClick(){click(saveLoadSettings);}
