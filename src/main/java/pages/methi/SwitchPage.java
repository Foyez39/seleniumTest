...
public class SwitchPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[11]/div/div[10]/div/a")
    private WebElement switchHover;
    ...
    public void hoverOverSwitchBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(switchHover).build().perform();
    }

    public void SwitchClick(){click(Switch);}
    ...
    public void appearanceClick(){click(appearance);}
    ...
    public void themesClick(){click(themes);}
