...
public class ProgressBarPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[4]/div/div[4]/div/a")
    private WebElement progressBarHover;
    ...
    private WebElement progressMonitoring;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement fileUploadProcess;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement templatesEasyCustomization;
    ...
    public void hoverOverProgressBarBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(progressBar).build().perform();
    }

    public void progressBarClick(){click(progressBar);}
    ...
    public void progressMonitoringClick(){click(progressMonitoring);}

    public void fileUploadProcessClick(){click(fileUploadProcess);}

    public void templatesEasyCustomizationClick(){click(templatesEasyCustomization);}
