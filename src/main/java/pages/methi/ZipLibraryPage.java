...
public class ZipLibraryPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[9]/div/div[6]/div/a")
    private WebElement zipLibraryHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[9]/div/div[6]/div/a")
    private WebElement zipLibrary;
    ...
    private WebElement zipLibraryOverview;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[2]/a")
    private WebElement flexibleAPICreateZipFiles;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[3]/a")
    private WebElement loadDataZipFiles;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[4]/a")
    private WebElement compressDecompress;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[5]/a")
    private WebElement deflateLZMACompression;

    @FindBy(xpath = "//*[@id=\"js-sidebar-menu\"]/li[5]/a")
    private WebElement supportLargeFiles;
    ...
    public ZipLibraryPage(WebDriver driver){
    ...
    public void hoverOverZipLibraryBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(zipLibraryHover).build().perform();
    }

    public void zipLibraryClick(){click(zipLibrary);}
    ...
    public void zipLibraryOverviewClick(){click(zipLibraryOverview);}

    public void flexibleAPICreateZipFilesClick(){click(flexibleAPICreateZipFiles);}

    public void loadDataZipFilesClick(){click(loadDataZipFiles);}

    public void compressDecompressClick(){click(compressDecompress);}

    public void deflateLZMACompressionClick(){click(deflateLZMACompression);}

    public void supportLargeFilesClick(){click(supportLargeFiles);}

    public void encryptionClick(){click(encryption);}
