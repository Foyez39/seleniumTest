...
public class MultiColumnComboBoxPage extends CommonAPI {
    ...
    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[7]/div/div[9]/div/a")
    private WebElement multiColumnComboHover;

    @FindBy(xpath = "//*[@id=\"ContentPlaceholder1_C417_Col00\"]/div/div[1]/ul/li[7]/div/div[9]/div/a")
    private WebElement multiColumnCombo;
    ...
    public MultiColumnComboBoxPage(WebDriver driver){
    ...
    public void hoverOverMultiColumnComboBtn(WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(multiColumnComboHover).build().perform();
    }

    public void multiColumnComboClick(){click(multiColumnCombo);}
