...
public class SignInTest extends CommonAPI {
    ...
    public void dellFinancialServiceBtn(){
        HomePage homePage=new HomePage(getDriver());
        Dropdown_SignIn_DellFinancialServicesPage dropdownSignInDellFinancialServicesPage =new Dropdown_SignIn_DellFinancialServicesPage(getDriver());
        homePage.hoverOverOnSignInBtn(getDriver());
        homePage.clickFinancialServiceBtn();
        Assert.assertTrue(dropdownSignInDellFinancialServicesPage.dellFinancialServiceTextIsPresent());
    }
    @Test
